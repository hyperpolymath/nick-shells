...
:experimental:
:url-github: https://github.com/hyperpolymath/nick-shells
:url-gitlab: https://gitlab.com/hyperpolymath/nick-shells
:url-bitbucket: https://bitbucket.org/hyperpolymath/nick-shells
:url-codeberg: https://codeberg.org/hyperpolymath/nick-shells

Nick's shell configuration collection
...
nick-shells is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
